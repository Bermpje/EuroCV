...
def test_convert_command_json(mock_convert, runner, sample_pdf_file, tmp_path):
    ...
    result = runner.invoke(
        app,
        ["convert", str(sample_pdf_file), "--out", str(output_file), "--no-validate"],
    )
...
def test_convert_command_stdout(mock_convert, runner, sample_pdf_file):
    ...
    result = runner.invoke(app, ["convert", str(sample_pdf_file), "--no-validate"])
...
def test_convert_with_locale(mock_convert, runner, sample_pdf_file):
    ...
    result = runner.invoke(
        app, ["convert", str(sample_pdf_file), "--locale", "nl-NL", "--no-validate"]
    )
...
def test_convert_with_ocr(mock_convert, runner, sample_pdf_file):
    ...
    result = runner.invoke(app, ["convert", str(sample_pdf_file), "--ocr", "--no-validate"])
...
def test_convert_no_photo(mock_convert, runner, sample_pdf_file):
    ...
    result = runner.invoke(app, ["convert", str(sample_pdf_file), "--no-photo", "--no-validate"])
...
%%EOF"""
    ...
    result = runner.invoke(
        app,
        ["batch", f"{tmp_path}/*.pdf", "--out-dir", str(output_dir), "--no-validate"],
    )
...
def test_convert_with_validation_warnings(mock_convert, runner, sample_pdf_file):
    ...
    result = runner.invoke(app, ["convert", str(sample_pdf_file), "--validate"])
...
%%EOF"""
    ...
    result = runner.invoke(app, ["batch", str(tmp_path / "*.pdf"), "--out-dir", str(output_dir)])
...
def test_batch_command_no_files(runner, tmp_path):
    ...
    result = runner.invoke(
        app, ["batch", str(tmp_path / "*.pdf"), "--out-dir", str(tmp_path / "output")]
    )
